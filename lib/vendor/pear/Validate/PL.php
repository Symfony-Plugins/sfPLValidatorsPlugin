 ...
 * @link      http://pear.php.net/package/Validate_PL
 */
class Validate_PL extends Validate
{
    /**
     ...
     * @return bool
     */
    public static function nip($nip)
    {
     ...
     * @return bool
     */
    public static function bankBranch($number)
    {
     ...
     * @return bool
     */
    public static function pesel($pesel, &$birth)
    {
     ...
     * @return bool
     */
    public static function region($regon)
    {
